...
public class GoslingHandshake {
    ...
    private static class GoslingCallbacks implements
        ...
        public long onIdentityClientHandshakeChallengeResponseSizeEvent(Context context, long handshake_handle, byte[] challenge_buffer) {
            return GoslingHandshake.EMPTY_BSON.length;
        }
        public void onIdentityClientHandshakeBuildChallengeResponseEvent(Context context, long handshake_handle, byte[] challenge_buffer, byte[] out_challenge_response_buffer) {
            ...
            assert out_challenge_response_buffer.length == GoslingHandshake.EMPTY_BSON.length;
            System.arraycopy(GoslingHandshake.EMPTY_BSON, 0, out_challenge_response_buffer, 0, GoslingHandshake.EMPTY_BSON.length);
        }
        ...
        public boolean onIdentityServerEndpointSupportedEvent(Context context, long handshake_handle, String endpoint_name) {
            ...
            return endpoint_name.equals(GoslingHandshake.ENDPOINT_NAME);
        }
        ...
        public void onIdentityServerHandshakeBuildChallengeEvent(Context context, long handshake_handle, byte[] out_challenge_buffer) {
            ...
            assert out_challenge_buffer.length == GoslingHandshake.EMPTY_BSON.length;
            System.arraycopy(GoslingHandshake.EMPTY_BSON, 0, out_challenge_buffer, 0, GoslingHandshake.EMPTY_BSON.length);
        }
        ...
        public boolean onEndpointServerChannelSupportedEvent(Context context, long handshake_handle, V3OnionServiceId client_service_id, String channel_name) {
            ...
            return channel_name.equals(GoslingHandshake.CHANNEL_NAME);
        }
    ...
    public static void run() throws Exception {
        ...
        long aliceIdentityHandshakeHandle = Gosling.contextBeginIdentityHandshake(aliceContext, bobIdServiceId, GoslingHandshake.ENDPOINT_NAME, outError);
        handleOutError(outError);
        ...
        Gosling.contextBeginEndpointHandshake(aliceContext, bobEndpointServerServiceId, bobEndpointServerClientAuthKey, GoslingHandshake.CHANNEL_NAME, outError);
        handleOutError(outError);
