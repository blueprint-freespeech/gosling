...
TEST_CASE("gosling_ed25519_private_key_generate") {
    ...
    // no valid dest
    REQUIRE_THROWS(::gosling_ed25519_private_key_generate(nullptr, throw_on_error()));

    // key generation should succeed
    REQUIRE_NOTHROW(::gosling_ed25519_private_key_generate(out(privateKeyAlice), throw_on_error()));
    REQUIRE_NOTHROW(::gosling_ed25519_private_key_generate(out(privateKeyPat), throw_on_error()));
...
TEST_CASE("gosling_ed25519_private_key_from_keyblob") {
    ...
    REQUIRE_THROWS(::gosling_ed25519_private_key_from_keyblob(out(privateKey), invalidKeyBlob.c_str(), invalidKeyBlob.size(), throw_on_error()));
...
TEST_CASE("gosling_x25519_private_key_from_base64") {
    ...
    // no valid inputs
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(nullptr, nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(nullptr, nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(nullptr, nullptr, X25519_PRIVATE_KEYBLOB_BASE64_SIZE, throw_on_error()));

    // valid dest, invalid base64, invaild base64 len
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(out(privateKey), nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(out(privateKey), nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(out(privateKey), nullptr, X25519_PRIVATE_KEYBLOB_BASE64_SIZE, throw_on_error()));

    // valid dest, valid base64, invaild base64 len
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(out(privateKey), base64.c_str(), 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(out(privateKey), base64.c_str(), 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(out(privateKey), base64.c_str(), X25519_PRIVATE_KEYBLOB_BASE64_SIZE, throw_on_error()));

    // invalid dest, valid base64, invalid base64 len
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(nullptr, base64.c_str(), 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(nullptr, base64.c_str(), 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(nullptr, base64.c_str(), X25519_PRIVATE_KEYBLOB_BASE64_SIZE, throw_on_error()));

    // invalid dest, valid base64, valid base64 len
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(nullptr, base64.c_str(), base64.size(), throw_on_error()));

    // valid dest, invalid base64, valid base64 len
    REQUIRE_THROWS(::gosling_x25519_private_key_from_base64(out(privateKey), invalidBase64.c_str(), invalidBase64.size(), throw_on_error()));
...
TEST_CASE("gosling_x25519_private_key_to_base64") {
    ...
    REQUIRE_THROWS(::gosling_x25519_private_key_to_base64(nullptr, nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_to_base64(nullptr, nullptr, X25519_PRIVATE_KEYBLOB_BASE64_LENGTH, throw_on_error()));

    // valid key, invalid out base64, invalid base64 size
    REQUIRE_THROWS(::gosling_x25519_private_key_to_base64(privateKey.get(), nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_to_base64(privateKey.get(), nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_to_base64(privateKey.get(), nullptr, X25519_PRIVATE_KEYBLOB_BASE64_LENGTH, throw_on_error()));

    // valid key, valid out base64, invalid base64 size
    REQUIRE_THROWS(::gosling_x25519_private_key_to_base64(privateKey.get(), base64Raw, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_private_key_to_base64(privateKey.get(), base64Raw, 1, throw_on_error()));
...
TEST_CASE("gosling_x25519_public_key_from_base32") {
    ...
    const std::string invalidBase32 = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    REQUIRE(base32.size() == X25519_PUBLIC_KEYBLOB_BASE32_LENGTH);
    REQUIRE(invalidBase32.size() == X25519_PUBLIC_KEYBLOB_BASE32_LENGTH);

    // no valid inputs
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(nullptr, nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(nullptr, nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(nullptr, nullptr, X25519_PUBLIC_KEYBLOB_BASE32_SIZE, throw_on_error()));

    // valid dest, invalid base32, invaild base32 len
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(out(publicKey), nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(out(publicKey), nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(out(publicKey), nullptr, X25519_PUBLIC_KEYBLOB_BASE32_SIZE, throw_on_error()));

    // valid dest, valid base32, invaild base32 len
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(out(publicKey), base32.c_str(), 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(out(publicKey), base32.c_str(), 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(out(publicKey), base32.c_str(), X25519_PUBLIC_KEYBLOB_BASE32_SIZE, throw_on_error()));

    // invalid dest, valid base32, invalid base32 len
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(nullptr, base32.c_str(), 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(nullptr, base32.c_str(), 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(nullptr, base32.c_str(), X25519_PUBLIC_KEYBLOB_BASE32_SIZE, throw_on_error()));

    // invalid dest, valid base32, valid base32 len
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(nullptr, base32.c_str(), base32.size(), throw_on_error()));

    // valid dest, invalid base32, valid base32 len
    REQUIRE_THROWS(::gosling_x25519_public_key_from_base32(out(publicKey), invalidBase32.c_str(), invalidBase32.size(), throw_on_error()));
...
TEST_CASE("gosling_x25519_public_key_to_base32") {
    ...
    REQUIRE_THROWS(::gosling_x25519_public_key_to_base32(nullptr, nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_to_base32(nullptr, nullptr, X25519_PUBLIC_KEYBLOB_BASE32_LENGTH, throw_on_error()));

    // valid key, invalid out base32, invalid base32 size
    REQUIRE_THROWS(::gosling_x25519_public_key_to_base32(publicKey.get(), nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_to_base32(publicKey.get(), nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_to_base32(publicKey.get(), nullptr, X25519_PUBLIC_KEYBLOB_BASE32_LENGTH, throw_on_error()));

    // valid key, valid out base32, invalid base32 size
    REQUIRE_THROWS(::gosling_x25519_public_key_to_base32(publicKey.get(), base32Raw, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_x25519_public_key_to_base32(publicKey.get(), base32Raw, 1, throw_on_error()));
...
TEST_CASE("gosling_v3_onion_service_id_from_string") {
    ...
    const std::string invalidServiceIdString = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa";
    REQUIRE(serviceIdString.size() == V3_ONION_SERVICE_ID_LENGTH);
    REQUIRE(invalidServiceIdString.size() == V3_ONION_SERVICE_ID_LENGTH);

    // no valid inputs
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(nullptr, nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(nullptr, nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(nullptr, nullptr, V3_ONION_SERVICE_ID_SIZE, throw_on_error()));

    // valid dest, invalid serviceIdString, invalid serviceIdString len
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(out(serviceId), nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(out(serviceId), nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(out(serviceId), nullptr, V3_ONION_SERVICE_ID_SIZE, throw_on_error()));

    // valid dest, valid serviceIdString, invalid serviceIdString len
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(out(serviceId), serviceIdString.c_str(), 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(out(serviceId), serviceIdString.c_str(), 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(out(serviceId), serviceIdString.c_str(), V3_ONION_SERVICE_ID_SIZE, throw_on_error()));

    // invalid dest, valid serviceIdString, invalid serviceIdString len
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(nullptr, serviceIdString.c_str(), 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(nullptr, serviceIdString.c_str(), 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(nullptr, serviceIdString.c_str(), V3_ONION_SERVICE_ID_SIZE, throw_on_error()));

    // invalid dest, valid serviceIdString, valid serviceIdString len
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(nullptr, serviceIdString.c_str(), serviceIdString.size(), throw_on_error()));

    // valid dest, invalid serviceIdString, valid serviceIdString len
    REQUIRE_THROWS(::gosling_v3_onion_service_id_from_string(out(serviceId), invalidServiceIdString.c_str(), invalidServiceIdString.size(), throw_on_error()));
...
TEST_CASE("gosling_v3_onion_service_id_to_string") {
    ...
    REQUIRE_THROWS(::gosling_v3_onion_service_id_to_string(nullptr, nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_to_string(nullptr, nullptr, V3_ONION_SERVICE_ID_LENGTH, throw_on_error()));

    // valid serviceId, invalid out serviceIdStringRaw, invalid serviceIdStringRaw size
    REQUIRE_THROWS(::gosling_v3_onion_service_id_to_string(serviceId.get(), nullptr, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_to_string(serviceId.get(), nullptr, 1, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_to_string(serviceId.get(), nullptr, V3_ONION_SERVICE_ID_LENGTH, throw_on_error()));

    // valid serviceId, valid out serviceIdStringRaw, invalid serviceIdStringRaw size
    REQUIRE_THROWS(::gosling_v3_onion_service_id_to_string(serviceId.get(), serviceIdStringRaw, 0, throw_on_error()));
    REQUIRE_THROWS(::gosling_v3_onion_service_id_to_string(serviceId.get(), serviceIdStringRaw, 1, throw_on_error()));
